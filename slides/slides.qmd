...
## Some Ideas and Next Steps {.smaller}

* Develop fully the transparency scoring
* The work focused on two papers; the proceess needs to be:
  * Streamlined and automated 
  * Applied on a larger pool of papers to quantify the results
* Work on the idea of interactive papers that communicate with each other using a machine layer

::: {style="text-align: center;"}
![](images/nano_banana_infographics.png){width="50%"}
:::

::: {.callout-note appearance="minimal"}
**Reference:** Science Should Be Machine-Readable [@booeshaghiScienceShouldBe2026]
:::
