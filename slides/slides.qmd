...
ggplot(scale_data, aes(x = 1, y = score, fill = score)) +
  geom_tile(width = 0.12) +  # thin bar
  ...
  annotate("text", x = 1.08, y = 10, label = "High transparency", hjust = 0, size = 10) +
  annotate("text", x = 1.08, y = 6, label = "Medium transparency", hjust = 0, size = 10) +
  annotate("text", x = 1.08, y = 2, label = "Low transparency", hjust = 0, size = 10) +
  labs(
    x = NULL,
...
## Investigated papers - Selection of papers {.smaller}
...
## Investigated papers - The two papers {.smaller}
...
## Revisiting Reproducibility in Transportation Simulation Studies - Methodology {.smaller}



## Towards Zero CO~2~ Emissions: Insights from EU Vehicle On-Board Data — Methodology {.smaller}
